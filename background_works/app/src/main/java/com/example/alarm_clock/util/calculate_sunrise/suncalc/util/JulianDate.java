 ...
 */
package com.example.alarm_clock.util.calculate_sunrise.suncalc.util;

import static com.example.alarm_clock.util.calculate_sunrise.suncalc.util.ExtendedMath.PI2;
import static com.example.alarm_clock.util.calculate_sunrise.suncalc.util.ExtendedMath.frac;
...
public class JulianDate {
    ...
    public JulianDate atModifiedJulianDate(double mjd) {
        Instant mjdi;
        mjdi = Instant.ofEpochMilli(round((mjd - 40587.0) * 86400000.0));
