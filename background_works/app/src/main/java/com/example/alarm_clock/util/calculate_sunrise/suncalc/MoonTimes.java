...
import static com.example.alarm_clock.util.calculate_sunrise.suncalc.util.ExtendedMath.apparentRefraction;
import static com.example.alarm_clock.util.calculate_sunrise.suncalc.util.ExtendedMath.parallax;
...
public final class MoonTimes {
    ...
    private static class MoonTimesBuilder extends BaseBuilder<Parameters> implements Parameters {
        private Duration limit = getYearDuration();//Duration.ofDays(365L);
        private double refraction = apparentRefraction(0.0);

        public Duration getYearDuration() {
